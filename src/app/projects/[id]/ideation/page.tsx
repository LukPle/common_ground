...
import { Lightbulb, Loader2, Image as ImageIcon, Sparkles, Send, ChevronRight, TriangleAlert, RotateCw, X } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 sm:p-10">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Enhance the Design</h1>
              ...
              <div className="mb-8">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-md border border-gray-200 cursor-pointer" onClick={() => openModal(project.image!)}>
              ...
              {generationError && !isGenerating && (
                <div className="mt-8 p-8 bg-amber-50 border border-amber-200 rounded-xl text-center">
                  ...
                  <p className="text-amber-800 text-sm max-w-md mx-auto">This can happen if the request is unclear or violates safety policies. Please try refining your prompt or click to try again.</p>
                  <button onClick={(e) => handleGenerateVision(e as any)} className="mt-6 bg-white border border-amber-300 rounded-full p-2 hover:bg-amber-100/50 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2" aria-label="Retry image generation">
              ...
              {generatedImage && !isGenerating && !generationError && (
                <div className="mt-10">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2"><Sparkles className="w-5 h-5 text-blue-600" />Enhanced Design</h3>
                  <div className="relative rounded-xl overflow-hidden shadow-lg border border-gray-200 mb-8 cursor-pointer" onClick={() => openModal(generatedImage)}>
                    <div className="aspect-[16/10] w-full">
                  ...
                  {submissionStatus !== 'success' && (
                    <form onSubmit={handleSubmitToDatabase} className="space-y-6 bg-gray-50 p-6 rounded-xl border border-gray-200">
                      ...
                      <button type="submit" disabled={!title.trim() || isSubmitting} className="w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-emerald-600 hover:to-green-700 transition-all shadow-md disabled:opacity-50 flex items-center justify-center gap-2">
